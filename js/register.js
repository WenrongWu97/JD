...
//		alert("手机号必须由数字组成");
		...
		phone.focus();
		return false;
	}else if(!/^1[38]\d{9}|15[012356789]\d{8}|14[57]\d{8}|17[678]\d{8}$/.test(phone.value)){
...
//		alert("手机验证码不能为空");
		validateCodeMsg.innerHTML = "<img src='images/!.png' alt='' />手机验证码不能为空";
		validateCode.focus();
		return false;
	}else if(!/^.{6}$/.test(validateCode.value)){
//		  if(validateCode.value.length != 6){
//		alert("手机验证码必须为6位");
		validateCodeMsg.innerHTML = "<img src='images/!.png' alt='' />手机验证码必须为6位";
		validateCode.focus();
		return false;
	}else if(!/^\d+$/.test(validateCode.value)){
//		  if(isNaN(validateCode.value)){
//		alert("手机验证码必须由数字组成");
		validateCodeMsg.innerHTML = "<img src='images/!.png' alt='' />手机验证码必须由数字组成";
		return false;
	}else{
//		alert("手机验证码格式正确");
		validateCodeMsg.innerHTML = "<img src='images/√.png' alt='' />手机验证码格式正确";
